...
const View = () => {
  ...
  return (
    <div
      id="relative view"
      className="relative p-5 min-h-[60vh] w-full bg-[#FFF5E5]"
    >
      <div className="absolute lg:right-0 w-full lg:w-1/2 mt-3 px-5 min-h-[50vh]">
        <div className="h-auto sm:h-[14ch] w-full flex flex-col sm:flex-row items-start  sm:items-center justify-between mt-10 px-2 sm:px-5 border-b-4 gap-4">
          <h1 className="nav font-light text-3xl sm:text-5xl lg:text-7xl uppercase text-black ">
            view all work
          </h1>
          <h1 className="nav text-4xl sm:text-6xl lg:text-8xl">{"-> -> ->"}</h1>
        </div>
        <div className="relative h-[25vh] sm:h[30vh] w-full sm:w-[40vw] lg:w-[20vw] bg-white mt-6 rounded-2xl overflow-hidden shadow-xl">
